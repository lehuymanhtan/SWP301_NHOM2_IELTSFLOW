...
<head>
    <meta charset="UTF-8">
    <title>Đang làm bài thi đầu vào – IELTSFlow</title>
...
<div class="top-bar">
    <div class="exam-title">
        Thi đầu vào: ${exam.title}
        <span>Đầy đủ 4 kỹ năng · ${exam.duration} phút</span>
    </div>
...
<div class="main">
    ...
    <form method="post" action="${pageContext.request.contextPath}/placement-test?action=submit" id="exam-form">
...
function triggerViolation(type) {
    ...
    fetch('${pageContext.request.contextPath}/placement-test?action=violation', {
        method: 'POST',
...
function confirmSubmit() {
    return confirm('Bạn có chắc chắn muốn nộp bài thi đầu vào? Hành động này không thể hoàn tác.');
}
</script>
</body>
</html>
