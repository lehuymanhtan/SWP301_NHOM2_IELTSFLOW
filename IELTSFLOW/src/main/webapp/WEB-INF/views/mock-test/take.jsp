...
<div class="main">
    ...
    <form method="post" action="${pageContext.request.contextPath}/mock-test?action=submit" id="exam-form" enctype="multipart/form-data">
...
function confirmSubmit() {
    return confirm('Bạn có chắc chắn muốn nộp bài? Hành động này không thể hoàn tác.');
}
</script>
</body>
</html>
